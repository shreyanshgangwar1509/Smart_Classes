...
//   useEffect(() => {
//     // Logic for any side effects based on role selection can go here
//   }, [selectedRole]);
...
//       callbackUrl: `/${data.identifier}/${selectedRole}/profile`,
//     });
...
function Page() {
  ...
  const callbackUrl = `/${data.identifier}/${selectedRole}/profile`;
